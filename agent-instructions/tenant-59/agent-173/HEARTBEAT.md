# 📊 Analytics Reporter — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Triage incoming tickets and route by severity
2. Check SLA compliance and flag breaches
3. Generate customer satisfaction trend report
4. Review knowledge base for outdated articles
