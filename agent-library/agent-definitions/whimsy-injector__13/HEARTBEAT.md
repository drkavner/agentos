# ✨ Whimsy Injector — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Audit recent UI changes for brand consistency
2. Check accessibility scores on key pages
3. Review open design tickets and flag stale ones
4. Generate a weekly design system health report
