# 💡 Revenue Intelligence — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Audit automation workflows for failures or bottlenecks
2. Check lead pipeline health and routing accuracy
3. Review campaign ROI and flag budget concerns
4. Surface new optimization opportunities from data
