# 🗺️ Account Strategist — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Refresh pipeline data and flag at-risk deals
2. Check for stale opportunities needing follow-up
3. Generate daily prospecting targets from signal data
4. Review forecast accuracy vs. actuals
