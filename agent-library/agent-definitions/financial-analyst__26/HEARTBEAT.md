# 📊 Financial Analyst — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Check budget burn rate and flag overages
2. Pull latest revenue numbers and update forecast
3. Review pending invoices and cash flow status
4. Run compliance check against policy thresholds
