# 💼 LinkedIn Content Creator — HEARTBEAT

## Scheduled Heartbeat Behavior
When my heartbeat fires, I run through these checks and report findings.

## Heartbeat Checklist
1. Pull latest campaign metrics and flag underperformers
2. Check content calendar for upcoming deadlines
3. Monitor competitor activity and surface new trends
4. Review SEO rankings and report significant changes
